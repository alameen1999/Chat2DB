export default {
  ...
  'chat.input.tableSelect.placeholder': 'Please choose tables or views',
  ...
  'chat.input.remain.tooltip': 'The manually selected tables or views will be synchronized to the AI context',
